...
We simulate a toy cross-sectional dataset with binary treatment to illustrate how to use **hbal**. 
```{r, message=FALSE}
library(hbal)
set.seed(1984)
N <- 500
...
We see that contender judges are more likely to rule in line with the ideology of the sitting president during a Supreme Court vancy.
...
### 5.3 Custom K-fold cross-validation
...
### 5.4 User-supplied base weights
