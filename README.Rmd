...
**Examples:** R code used in the [tutorial](https://yiqingxu.org/packages/hbal/) can be downloaded from [here](https://raw.githubusercontent.com/xuyiqing/hbal/main/tutorial/hbal_examples.R).
